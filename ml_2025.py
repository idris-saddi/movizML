...
Original file is located at
    https://colab.research.google.com/drive/1D9MIpTjfwcdPq--4y2qI82a8vYU_gSyU
"""
...
df_genres_added = df_added_mpaa_dummies['genres'].str.split(',').apply(lambda x: [genre.strip() for genre in x if genre.strip()])
